...
{
	kade_mand opst[] = {
				{"push", kade_insert}, {"pall", kade_print},
				{"pint", kade_ptop}, {"pop", kade_pop},
				{"swap", kade_flip},
				{"add", kade_sum},
				{"nop", kade_recessive},
				{"sub", kade_sub},
				{"div", kade_div},
				{"mul", kade_mul}, {"mod", kade_modul},
				{"pchar", kade_pchar}, {"pstr", kade_pstr},
				{"rotl", kade_lrot},
				{"rotr", kade_rrot},
				{"queue", kade_set},
				{"stack", kade_arrange},
	...
	{ fprintf(stderr, "L%d: this instruction unknown %s\n", num, day);
		fclose(file);
		free(text);
		 kade_free(*stack);
		exit(EXIT_FAILURE); }
